...
String textAbout =
        "Суть игры в том, чтобы уничтожить всех тараканов.\n"+
        "На каждом уровне сложности разное кол-во тараканов.\n"+
        "Игра была создана для изучения основ программирования.\n";
